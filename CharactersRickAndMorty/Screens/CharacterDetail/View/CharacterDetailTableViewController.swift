...
//                detailView.heightAnchor.constraint(equalToConstant: heightForHeader).isActive = true
//                detailView.widthAnchor.constraint(equalToConstant: view.frame.width).isActive = true
//        return detailView
//    }
    ...
    private func bind() {
        viewModel.displayPublishRelay.observe(on: MainScheduler.instance).subscribe { [weak self] _ in
